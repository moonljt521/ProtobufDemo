...
void protobuf_AssignDesc_book_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
GOOGLE_PROTOBUF_DECLARE_ONCE(protobuf_InitDefaults_book_2eproto_once_);
void protobuf_InitDefaults_book_2eproto() {
  ::google::protobuf::GoogleOnceInit(&protobuf_InitDefaults_book_2eproto_once_,
                 &protobuf_InitDefaults_book_2eproto_impl);
}
...
Book::Book()
  ...
  if (this != internal_default_instance()) protobuf_InitDefaults_book_2eproto();
  SharedCtor();
